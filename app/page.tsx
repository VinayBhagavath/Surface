...
// Intake — the landing page. Variant + clinical context -> emit the pipeline
// event -> /session/[runId] on the live Inngest stream.
...
/** Pick a visual/demo hint only. It never changes the live run input. */
  ...
  function launch(v: string, ctx: string, demo?: DemoId) {
    ...
    startTransition(async () => {
      try {
        ...
        toast.error("Could not start the evidence run. Check that Next and Inngest dev are running.");
        return;
      }
